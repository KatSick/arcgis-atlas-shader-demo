 ...
 * through MapLibre's CustomLayerInterface. Multipoint tactical graphics ride
 * the mil-sym-ts pipeline (styled GeoJSON on native layers), exactly as in
 * the universal demos — see RESEARCH.md §5.3 for why the two compose.
 */
...
async function main() {
  ...
  // ---- point symbols: CIM dictionary atlas + shared instanced WebGL core ----
